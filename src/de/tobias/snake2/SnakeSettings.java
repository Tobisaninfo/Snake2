...
public class SnakeSettings implements SettingsSerializable {
	...
	@Storable public int s_highScore = 0;
	@Storable public int s_defaultBarrieres = 20;
	@Storable public int s_defaultSnakeLength = 5;
	@Storable public int s_addLengthThenEat = 5;
	@Storable public int s_moveThreshold = 150;
}
